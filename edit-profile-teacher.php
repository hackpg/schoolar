  ...
  <body>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <form id="contact" action="edit-profile-teacher.php" method="POST">
                    <h1 style="text-align: center;font-family: sans-serif;">Fill Profile</h1><hr>
                       ...
                       <div class="form-group">
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Degree" name="degree">
                      </div>
...
if(isset($_POST['name']) && isset($_POST['address']) && isset($_POST['email'])&& isset($_POST['contact'])&& isset($_POST['degree'])&& isset($_POST['occupation']))
{
    ...
    if(!empty($username)&&!empty($name)&&!empty($address)&&!empty($contact)&&!empty($degree)&&!empty($occupation)&&!empty($email1))
    {
      $q = "INSERT INTO `teacher` (`id`, `name`, `address`, `contact`, `degree`, `Occupation`, `username`, `email`) VALUES (NULL, '$name', '$address', '$contact', '$degree', '$occupation', '$username', '$email1')";
