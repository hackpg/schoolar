                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="#tf-portfolio">Register Parent</a></li>
                          ...
                          <li><a href="profile-parent.php">View Profile</a></li>
                          <li><a href="edit-parent-profile.php">Edit Profile</a></li>
                        <li><a href="#tf-about">Logout</a></li>
                      </ul>
                    </div><!-- /.navbar-collapse -->
                </div><!-- /.container-fluid -->
            </nav>
<a href="edit-parent-profile.php">Edit Profile</a>            
             <?php
require 'conn.inc.php';
        $username=$_SESSION['username'];
      $q = "SELECT `name`,`address`,`contact`,`email`,`occupation`,`studentname` FROM `parent` WHERE `username`='$username'";
      $result=$conn->query($q);
      ...
      if($result->num_rows>0)
      {
       ...
       echo "<h3>Associated Student name:</h3><p>".row['studentname']."</p>";
      }      
      else
      {
        echo $conn->error;
